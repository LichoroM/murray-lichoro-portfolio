...
export const experiences: Experience[] = [
  {
    ...
    type: "full-time",
    description: "Delivered comprehensive IT services and support to technical and non-technical staff for company operations. Provided technical leadership across IT service teams.",
    responsibilities: [
      "Delivered clear, thorough IT services support for technical and non-technical staff",
      ...
      "Performed systems testing, hardware setup, and software configuration to detect inefficiencies and vulnerabilities",
